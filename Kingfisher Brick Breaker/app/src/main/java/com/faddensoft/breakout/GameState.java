...
public class GameState {
     ...
     * the play area.
     */
    static final float ARENA_WIDTH = 1500.0f;
    ...
    void allocBorders() {
      ...
      //  rect.loadGLTexture(this.context);
        mBackground = rect;
    ...
    void movePaddle(float arenaX) {
        ...
        //Log.v(TAG, "PaddleMove at x=" + arenaX);
    ...
    void drawMessages() {
        ...
        if(mGameStatusMessageNum == TextResources.GAME_OVER)
        {
    ...
    void calculateNextFrame() {
        ...
        else if(mGamePlayState==GAME_LOST)
        {
